...
void pantallaCargaSimple() {
    ...
    // Animaci√É¬≥n de un solo recorrido
    for (pos_x = 5; pos_x < max_x; pos_x += 3) {
        ...
        Sleep(100); // Velocidad de animaci√É¬≥n (ajustable)
...
void mostrar(int pos1, int pos2, int desde, int hasta, Reserva nueva){
	...
	switch(op){
		...
		case 18: cout << "Linea de crucero: "<< nueva.linea_crucero; break;
		default: ;
		}
	}
}//Fin Mostrar

void mostrar_sinlimpiar(int pos1, int pos2, int desde, int hasta, Reserva nueva){
	int op;
	for(op=desde;op<=hasta;op++,pos2++)
	{
	gotoxy(pos1,pos2);
...
void mostrar_pasajeros_sinlimpiar(int pos1, int pos2, int desde, int hasta, Reserva nueva, int npasajero)
{
	int op;
	for(op=desde;op<=hasta;op++,pos2++)
	{
...
void incluir(){
    ...
    if (buscarReserva(nueva.numero_reserva, nueva) == 0) {
		...
		mostrar(3,6,6,7,nueva);
		mostrar_sinlimpiar(3,8,18,18,nueva);
		mostrar_sinlimpiar(3,9,8,9,nueva);
		gotoxy(40,2); cout<< "INFORMACION DEL VIAJE";//Encabezado
...
if (respuesta == 'S' || respuesta == 's') {
    ...
    while (i < res.num_pasajeros) {
        ...
        if (i < res.num_pasajeros) {
            gotoxy(40, 27); cout << "Presione una tecla para ver mas pasajeros...";
            getch();
        }
    }
...
void modificarReserva() {
    ...
    while (fread(&res, sizeof(Reserva), 1, fOriginal)) {
            ...
            do {
                ...
                switch(opcion_modificar) {
                    case 1: {
                        ...
                        mostrar(3,6,1,1,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						gotoxy(60,6); cout << "Nombre del solicitante: ";
                        cin.ignore();
                        cin.getline(res.soli.nombre, sizeof(res.soli.nombre));
						mostrar(3,6,1,2,res);
						gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,1,1,res);
						gotoxy(60, 7); cout << "Pasaporte: ";
                        cin.getline(res.soli.pasaporte, sizeof(res.soli.pasaporte));
                       	mostrar(3,6,1,3,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,1,2,res);
					   
					    res.soli.edad = validar_numero(1,100,"Edad (1-100): ",60,8);
					    mostrar(3,6,1,4,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,1,3,res);
					   
					    char temp = validar_dosletras("Genero (M/F): ",60,9,"M","F","m","f");
                        strcpy(res.soli.genero, (temp=='m'||temp=='M') ? "Masculino" : "Femenino");
					    mostrar(3,6,1,5,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,1,4,res);
	
						gotoxy(60,10); cout << "El solicitante viaja? <1>Si <2>No: ";
						int viaja = validar_numero(1,2,"Opcion: ",60,11);
                        strcpy(res.soli.viaja, viaja==1 ? "Si" : "No");
					    mostrar(3,5,1,6,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,1,5,res);
						
						gotoxy(50,25);cout<<"Pulse una tecla para continuar.....";getch();
                    ...
                    case 2: {
                        ...
                        mostrar(3,6,6,6,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						gotoxy(60,6); cout << "Puerto de salida: ";
                        cin.ignore();
						...
						mostrar(3,6,6,7,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,6,6,res);
						gotoxy(60,7); cout << "Destino: ";
                        cin.getline(res.destino, sizeof(res.destino));
                        
						
						mostrar(3,6,6,7,res);
						mostrar_sinlimpiar(3,8,18,18,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,6,7,res);
						gotoxy(60,8); cout << "Linea de crucero: ";
						...
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,6,7,res);
						mostrar_sinlimpiar(60,8,18,18,res);
						mostrar_sinlimpiar(3,9,8,8,res);
						gotoxy(60,9); cout << "Codigo de viaje: ";
						...
						mostrar_sinlimpiar(60,6,6,7,res);
						mostrar_sinlimpiar(60,8,18,18,res);
						mostrar_sinlimpiar(60,9,8,8,res);
						mostrar_sinlimpiar(3,9,8,9,res);
						gotoxy(60,10); cout << "Categoria de cabina: ";
                        
						gotoxy(55,11); cout << "<1> Interior <2> Exterior <3> Balcon <4> Suite";
                        int op = validar_numero(1,4,"Opcion: ",60,12);
                        switch(op) {
						...
						mostrar_sinlimpiar(60,6,6,7,res);
						mostrar_sinlimpiar(60,8,18,18,res);
						mostrar_sinlimpiar(60,9,8,9,res);
						mostrar_sinlimpiar(3,9,8,9,res);
						gotoxy(50,25);cout<<"Pulse una tecla para continuar.....";getch();
                    ...
                    case 3: {
						...
						mostrar(3,6,10,10,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
                        res.fecha_salida.mes = validar_numero(1,12,"Mes de salida(1-12): ",60,6);
                        int maxdia = 31;
                        if(res.fecha_salida.mes==4 || res.fecha_salida.mes==6 || res.fecha_salida.mes==9 || res.fecha_salida.mes==11) maxdia=30;
                        
						mostrar(3,6,10,11,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,10,res);
                        res.fecha_salida.dia = validar_numero(1,maxdia,"Dia de salida : ",60,7);
                        
						mostrar(3,6,10,12,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,11,res);
                        res.fecha_salida.anio = validar_numero(2025,2100,"Ano de salida(2025-2100): ",60,8);
                        
						mostrar(3,6,10,13,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,12,res);
						res.embarque.hora = validar_numero(0,23,"Hora embarque(0-23): ",60,9);
                        
						mostrar(3,6,10,14,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,13,res);
                        res.embarque.minuto = validar_numero(0,59,"Minutos embarque(0-59): ",60,10);

                        
						mostrar(3,6,10,15,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,14,res);
                        res.fecha_reserva.mes = validar_numero(1,12,"Mes reserva(1-12): ",60,11);
                        maxdia = (res.fecha_reserva.mes==4 || res.fecha_reserva.mes==6 || res.fecha_reserva.mes==9 || res.fecha_reserva.mes==11)?30:31;
                        
						mostrar(3,6,10,16,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,15,res);
                        res.fecha_reserva.dia = validar_numero(1,maxdia,"Dia reserva: ",60,12);
                        
						mostrar(3,6,10,17,res);
                        gotoxy(12,3);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,16,res);
                        res.fecha_reserva.anio = validar_numero(2024,2100,"Ano reserva (2024-2100): ",60,13);
                        
						mostrar(3,6,10,17,res);
						gotoxy(12,2);cout<<"ACTUAL";gotoxy(70,3);cout<<"MODIFICANDO"; //Encabezado.
						mostrar_sinlimpiar(60,6,10,17,res);
        ...
        // Guardar en temporal: solo guardar modificado si es la reserva que cambia,
        ...
        if (encontrado && strcmp(res.numero_reserva, nroReservaBuscada) == 0) {
            if (cambios) {
                ...
                // Si no hubo cambios, guarda la original (opcional, aqua igual que el actual)
                fwrite(&res, sizeof(Reserva), 1, fTemp);
            }
        } else {
            fwrite(&res, sizeof(Reserva), 1, fTemp);
...
void reporteLineaCrucero() {
    ...
    gotoxy(3, 17); cout << "2. Dolares (USD)";
    gotoxy(3, 18); cout << "3. Bolivares (BS)";
    gotoxy(3, 19); cout << "Opcion: ";

    // Validar opci√≥n de orden
    do {
        borrarLinea(3, 11); // Borrar la linea anterior
        gotoxy(3, 11); cout << "Opcion: ";
        cin >> orden;
        if (orden < 1 || orden > 2) {
            gotoxy(3, 13); cout << "Opcion invalida. Por favor, ingrese una opcion valida.";
            getch();
            borrarLinea(3, 13); // Borrar el mensaje de error
        }
    } while (orden < 1 || orden > 2);
    
    // Validar opcion de moneda
    do {
        borrarLinea(3, 19); // Borrar la linea anterior
        gotoxy(3, 19); cout << "Opcion: ";
        cin >> moneda;
        if (moneda < 1 || moneda > 3) {
            gotoxy(3, 21); cout << "Opcion invalida. Por favor, ingrese una opcion valida.";
            getch();
    ...
    if (moneda > 1) {
        do {
            borrarLinea(3, 23); // Borrar la l√≠nea anterior
            gotoxy(3, 23); cout << "Ingrese tasa de cambio (1 EUR = ?): ";
            cin >> tasa;
            if (tasa <= 0) {
                gotoxy(3, 25); cout << "Tasa de cambio invalida. Por favor, ingrese un valor positivo.";
                getch();
    ...
    if (cont == 0) {
        gotoxy(3, 27); cout << "No se encontraron reservas para esta linea.";
        getch();
        return;
    }
...
void reporteViajesTemporada() {
    ...
    // Validar dÌa seg˙n mes
    int maxDia;
    if (fechaInicio.mes == 4 || fechaInicio.mes == 6 || fechaInicio.mes == 9 || fechaInicio.mes == 11) {
        maxDia = 30;
        fechaInicio.dia = validar_numero(1, 30, "  DÌa (1-30): ", 3, 8);
    } else if (fechaInicio.mes == 2) {
        maxDia = 28;
        fechaInicio.dia = validar_numero(1, 28, "  DÌa (1-28): ", 3, 8);
    } else {
        maxDia = 31;
        fechaInicio.dia = validar_numero(1, 31, "  DÌa (1-31): ", 3, 8);
    }
    ...
    gotoxy(3, 6); cout << "FECHA INICIAL DEL RANGO:";
    gotoxy(3, 7); cout << "  Mes (1-12): " << fechaInicio.mes;
    gotoxy(3, 8); cout << "  DÌa (1-" << maxDia << "): " << fechaInicio.dia;
    
    // Validar aÒo
    fechaInicio.anio = validar_numero(2024, 2100, "  AÒo (2024-2100): ", 3, 9);
    ...
    do {
        ...
        if (fechaFin.mes == 4 || fechaFin.mes == 6 || fechaFin.mes == 9 || fechaFin.mes == 11) {
            maxDia = 30;
            fechaFin.dia = validar_numero(1, 30, "  DÌa (1-30): ", 3, 8);
        } else if (fechaFin.mes == 2) {
            maxDia = 28;
            fechaFin.dia = validar_numero(1, 28, "  DÌa (1-28): ", 3, 8);
        } else {
            maxDia = 31;
            fechaFin.dia = validar_numero(1, 31, "  DÌa (1-31): ", 3, 8);
        }
        ...
        gotoxy(3, 6); cout << "FECHA FINAL DEL RANGO (posterior a " 
                                << fechaInicio.dia << "/" << fechaInicio.mes << "/" << fechaInicio.anio << "):";
        gotoxy(3, 7); cout << "  Mes (1-12): " << fechaFin.mes;
        gotoxy(3, 8); cout << "  DÌa (1-" << maxDia << "): " << fechaFin.dia;
        
        // Validar aÒo
        fechaFin.anio = validar_numero(2024, 2100, "  AÒo (2024-2100): ", 3, 9);
    ...
    int opcionEstado = validar_numero(1, 3, "Opcion: ", 3, y_pos++);
...
void CancelacionesPorEdadDestino() {
    ...
    edad_min = validar_numero(0, 100, "Edad minima para filtrar: ", 30, 7);
    ...
    gotoxy(10, 5); cout << "Edad minima: " << edad_min;
    if (usarFiltro) {
        ...
        if (!r.activa && strcmp(r.destino, destino) == 0) {
            for (int i = 0; i < r.num_pasajeros; i++) {
                ...
                if (p.edad >= edad_min && (!usarFiltro || strcmp(r.categoria_cabina, cabinaFiltro) == 0)) {
                    gotoxy(10, y++); cout << "Pasajero: " << p.nombre << ", Edad: " << p.edad << ", Genero: " << p.genero;
...
void revisionCapacidadCabina() {
    ...
    gotoxy(35, 8); cout<<"Opcion: "; cin>>aux;
