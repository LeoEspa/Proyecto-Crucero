...
// Función para mostrar una reserva (simplificada para reportes)
void mostrarReservaSimple(Reserva r) {
...
void reportes() {
    ...
    do {
        ...
        gotoxy(40, 17); cout << "Opción: "; cin>>op;
...
void reporteLineaCrucero() {
    ...
    gotoxy(3, 15); cout << "2. Dólares (USD)";
    ...
    if(cont == 0) {
        gotoxy(3, 21); cout << "No se encontraron reservas para esta línea.";
        getch();
        return;
    }
...
void mostrar2(int pos1, int pos2, int desde, int hasta, Fecha fecha) {
    ...
    for(op = desde; op <= hasta; op++, pos2++) {
        ...
        switch(op) {
            ...
            case 2: cout << "Día: " << fecha.dia; break;
            case 3: cout << "Año: " << fecha.anio; break;
            default: ;
        }
    }
}
